...
set ::env(DESIGN_NAME) adc_digital_control
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/../../verilog/rtl/adc_digital_control.v $::env(DESIGN_DIR)/../../verilog/rtl/traffic_lights.v $::env(DESIGN_DIR)/../../verilog/rtl/glue_logic.v $::env(DESIGN_DIR)/../../verilog/rtl/datapath.v $::env(DESIGN_DIR)/../../verilog/rtl/counter.v $::env(DESIGN_DIR)/../../verilog/rtl/control_unit.v"
